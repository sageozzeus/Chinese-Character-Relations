...
from chinese_char_relations.about_meta import ADDON_VERSION, CHANGELOG  # noqa: E402

REPO = "sageozzeus/Chinese-Character-Relations"
...
def _api(
    ...
    *,
    ...
    headers = {
        ...
        "User-Agent": "hanzi-relatives-release",
    }
    if extra_headers:
...
def _release_notes(version: str) -> str:
    lines = [f"## Chinese Character Relations {version}", ""]
...
def main() -> None:
    ...
    tag = f"v{version}"
    asset_path = ROOT / f"chinese_char_relations-{version}.ankiaddon"
